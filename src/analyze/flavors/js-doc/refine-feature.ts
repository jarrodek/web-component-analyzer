...
function applyJsDocAttribute<
  T extends Partial<Pick<ComponentMember, 'propName' | 'attrName' | 'default' | 'type' | 'typeHint'>>,
 ...
 * @param context
 */
function applyJsDocType<T extends Partial<Pick<ComponentMember, 'type' | 'typeHint'>>>(
  feature: T,
  jsDoc: JsDoc,
